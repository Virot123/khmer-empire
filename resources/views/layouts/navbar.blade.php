...
<nav class="var-navbar bg-body-tertiary">
    <div class="vr-wrapper-navbar">
      <div class="vr-flex vr-navbar-left">
        <button id="sidebarCollapse" type="submit" class="btn btn-light bg-white rounded-pill shadow-sm px-4 "><i class="fa fa-bars mr-2 vr-icon-menu"></i><i style="display: none" class="fas fa-caret-right vr_icon_right vr-icon-right vr-none"></i> </button>
