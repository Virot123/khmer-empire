  ...
  <div class="vr-main-content">
    <div class="vr-head-content">
      <div class="vr-head-content-top">
        <div class="vr-head-content-top-title">CIVILIZATIONS </div>
        <a href="/dashboard/civilization" class="autoSave superLink" id="autoSave"></a>
        ...
        <div class="vr-btn-add vr__btn_popup" data-url="/dashboard/civilization/create">
              ...
              <td>
                <div class="vr-dropdown-wrapper vr__dropdown_wrapper">
                  ...
                  <div class="vr-dropdown-box vr_dropdown_box">
                    <div class="vr-dropdown-list c-green vr__btn_popup" data-url="/dashboard/civilization/{{ $item->id }}">
                      <div class="vr-dropdown-list-left"><i class="fas fa-eye"></i></div>
                      <div class="vr-dropdown-list-right " >View</div>
                    </div>
                    <div class="vr-dropdown-list c-blue vr__btn_popup" data-url="/dashboard/civilization/{{ $item->id }}/edit">
                      <div class="vr-dropdown-list-left"><i class="far fa-edit"></i></div>
                      <div class="vr-dropdown-list-right " >Edit</div>
                    </div>
                    <div class="vr-dropdown-list c-red vr_remove_record"  id="{{ $item->id }}" table="civilizations">
